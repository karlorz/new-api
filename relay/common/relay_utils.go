...
// SanitizeURLForLog masks credentials carried in query parameters while
// preserving enough of the upstream URL to diagnose routing failures.
...
func isSensitiveURLQueryKey(key string) bool {
	...
	switch normalized {
	case "key", "api_key", "api-key", "apikey", "x-api-key",
		"access_token", "refresh_token", "id_token", "token",
		"authorization", "auth", "client_secret", "secret",
		"password", "passwd", "signature", "sig", "awsaccesskeyid",
